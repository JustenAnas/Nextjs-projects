...
const VEHICLE_META: any = {
  ...
  truck: { label: "Truck", Icon: BusFront },
};
interface IVehicle {
  _id: string;
  owner: string;
...
function Page() {
  ...
  //     vehicle
  //   );
  // }, [pickUpLat, pickUpLon, pickUp, drop]);
  useEffect(() => {
    console.log("effect fired", pickUpLat, pickUpLon, vehicle);
    if (!pickUpLat || !pickUpLon) return;
            ...
            {!loading && vehicles.length === 0 && (
              ...
              >
                ...
                <p className="text-zinc-400 text-sm max-w-xs leading-relaxed">
                  {meta?.label || "Vehicle"} drivers are not available near your
                  pickup right now.
                </p>
