...
const VEHICLE_META: any = {
  ...
  car: { label: "Car", Icon: Van },
  bus: { label: "Bus", Icon: BusFront },
  truck: { label: "Truck", Icon: Truck },
  other: { label: "Other", Icon: Van },
};
...
function Page() {
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      if (paymentMethod === "online") {
        ...
        setLoading(false);
        if (data.success) {
          toast.success("Cash payment confirmed! Driver will arrive soon.");
          setStatus("confirmed");
  ...
  const handleCancelBooking = useCallback(async () => {
    console.log("BOOKING INSIDE CANCEL", booking);
    try {
                ...
                {status == "confirmed" && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Driver is on the way.Track live from the ride screen
                      </motion.p>
                    </div>
                    <motion.button
                      initial={{ opacity: 0, y: 8 }}
