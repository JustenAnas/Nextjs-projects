  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center px-6  py-12">
        ...
        >
          <p className="text-zinc-400 text-xs uppercase tracking-[0.25em] font-semibold text-center">
            Trip Complete
          </p>
          ...
          <p className="text-zinc-500 text-sm text-center mb-8">
            {role == "driver"
              ...
              : "You have successfully dropped by driver."}
          </p>
          ...
          {booking.user && (
            <div className="bg-zinc-900 border-zinc-800 rounnded-2xl p-4 flex items-center gap-3 mb-3">
          ...
          <button
            onClick={() => router.push("/")}
            className="w-full border border-zinc-700 text-zinc-400 py-3 rounded-2xl text-sm font-semibold hover:bg-zinc-900 transition-colors"
          >
            Back To Home
          </button>
        </motion.div>
